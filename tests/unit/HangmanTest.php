...
class HangmanTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testPlayerOnePlaysOneGoodLetter() {
        ...
        $this->assertInstanceOf('\\MiniGame\\Hangman\\Result\\HangmanGoodProposition', $feedback);
    ...
    public function testPlayerOnePlaysOneBadLetter() {
        ...
        $this->assertInstanceOf('\\MiniGame\\Hangman\\Result\\HangmanBadProposition', $feedback);
        $this->assertEquals($this->playerOne, $feedback->getPlayer());
    ...
    public function testPlayerOneFindsSolution() {
        /* @var $feedback HangmanWon */
        $feedback = $this->hangman->play($this->playerOne, self::WORD);

        $this->assertInstanceOf('\\MiniGame\\Hangman\\Result\\HangmanWon', $feedback);
        $this->assertEquals($this->playerOne, $feedback->getPlayer());
    ...
    public function testPlayerOneFindsLastLetter() {
        ...
        /* @var $feedback \MiniGame\Hangman\Result\HangmanWon */
    ...
    public function testPlayerOneLoses() {
        ...
        /* @var $feedback \MiniGame\Hangman\Result\HangmanLost */
        $feedback = $hangman->play($this->playerOne, 'Z');

        $this->assertInstanceOf('\\MiniGame\\Hangman\\Result\\HangmanLost', $feedback);
        $this->assertEquals($this->playerOne, $feedback->getPlayer());
        $this->assertEquals(array('Z'), $feedback->getLettersPlayed());
