...
use MiniGame\Manager\InMemoryPlayerManager;
use MiniGame\Test\Mock\GameObjectMocker;
use TwitterStream\Test\Mock\TwitterObjectMocker;
...
class InMemoryPlayerManagerTest extends \PHPUnit_Framework_TestCase {
    ...
    public function setUp() {
        ...
        $this->user = $this->getTwitterUser($this->playerId, $this->playerName);
    ...
    public function testConstructor() {
        ...
        $manager = new InMemoryPlayerManager(array($this->playerId, $this->player));
    ...
    public function testSave() {
        ...
        $manager = new InMemoryPlayerManager();
